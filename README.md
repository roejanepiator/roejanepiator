...
|---|---|
| Computer Programming (OOP) | Classes, Inheritance, Polymorphism, Encapsulation |
| Web System Development | PHP, Laravel MVC, REST, Front-end Integration |
| Information Management | Database Design, ERD, SQL Queries |
| Data Structures & Algorithms | Arrays, Linked Lists, Sorting, Searching |
| Advanced Database Structure | Stored Procedures, Normalization, Optimization |
